...
db = mysql.connector.connect(host="sql6.freesqldatabase.com", user="sql6582218", passwd="KNAZUQReNL",
                             database="sql6582218")
cursor = db.cursor()
...
def sendMail(Name, Reciver_Mail):
    ...
    urllib.request.urlretrieve(
        'https://thumbs.dreamstime.com/b/colorful-happy- birthday-cupcakes-candles-spelling-148323072.jpg', "HBD.jpg")
